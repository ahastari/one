...
(window.Modernizr = (function (e, t, n) {
  ...
  var r = "2.8.3",
    ...
    T = {}.hasOwnProperty,
    N;
  !L(T, "undefined") && !L(T.call, "undefined")
    ? (N = function (e, t) {
        return T.call(e, t);
      })
    : (N = function (e, t) {
  ...
  for (var D in m)
    N(m, D) &&
      ((E = D.toLowerCase()), (i[E] = m[D]()), b.push((i[E] ? "" : "no-") + E));
  return (
    (i.addTest = function (e, t) {
      if (typeof e == "object") for (var r in e) N(e, r) && i.addTest(r, e[r]);
      else {
        e = e.toLowerCase();
        if (i[e] !== n) return i;
